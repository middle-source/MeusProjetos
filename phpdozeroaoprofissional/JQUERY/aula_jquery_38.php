...
<html>
    <head>
        ...
        <title>jQuery - Aula 38</title>
        <style>
            .area{width: 80px; height: 65px; border: 2px solid #000; float: left; text-align: center; padding-top: 15px;}
            .placar{width: 252px; height: 80px;}
        </style>
    ...
    <body>
        ...
        <script src = "./js/script_38.js"></script>
    </body>
</html>